                ...
                <div className="md:w-full px-2">
                  ...
                  <div className="md:mx-2">
                    <p className="p-4 border text-white border-t-transparent text-sm text-justify">
                      ...
                      Magnet Recruit в 2017 году с целью создания продвижение
                      культуры в сфере подбора персонала, которая ставит
                      клиентов и кандидатов на первое место.
                    </p>
                  </div>
                ...
                <div className="md:w-full px-2">
                  ...
                  <div className="md:mx-2">
                    <p className="p-4 border text-white border-t-transparent text-sm text-justify">
                      ...
                      границей, Ильджас создал компанию Magnet Recruit, которая
