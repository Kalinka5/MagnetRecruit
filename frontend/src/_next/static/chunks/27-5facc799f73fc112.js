                      ...
                      if (
                        ...
                        E(this, "pasteString", function (e) {
                          ...
                          return a(e)
                            ...
                            : (e &&
                                g.addEventToQueue(_, { character: e, node: t }),
                              g);
                        }),
                            ...
                            for (var o = 0; o < n.length; o++) {
                              ...
                              a && 3 !== a.nodeType
                                ? ((a.innerHTML = ""),
                                  ...
                                  r ? g.pasteString(s, a) : g.typeString(s, a))
                                : a.textContent &&
                                  (r
                                    ? g.pasteString(a.textContent, t)
                                    : g.typeString(a.textContent, t));
                            }
                          return g;
                        }),
                        E(this, "deleteAll", function () {
                          var e =
                            arguments.length > 0 && void 0 !== arguments[0]
                              ? arguments[0]
                              : "natural";
                          return g.addEventToQueue(p, { speed: e }), g;
                        }),
                        ...
                        E(this, "changeDelay", function (e) {
                          ...
                          return g.addEventToQueue(y, { delay: e }), g;
                        }),
                        E(this, "changeCursor", function (e) {
                          if (!e) throw Error("Must provide new cursor");
                          return g.addEventToQueue(b, { cursor: e }), g;
                        }),
                        ...
                        E(this, "callFunction", function (e, t) {
                          ...
                          return g.addEventToQueue(v, { cb: e, thisArg: t }), g;
                        }),
                        E(this, "typeCharacters", function (e) {
                          ...
                          return (
                            e.forEach(function (e) {
                              g.addEventToQueue(u, { character: e, node: t });
                            }),
                            g
                          );
                        }),
                        ...
                        E(this, "addEventToStateProperty", function (e, t) {
                          ...
                          return (
                            (g.state[n] = r
                              ? [o].concat(w(g.state[n]))
                              : [].concat(w(g.state[n]), [o])),
                            g
                          );
                        }),
                        E(this, "runEventLoop", function () {
                          ...
                          if (!g.state.eventQueue.length) {
                            ...
                            (g.state.eventQueue = w(g.state.calledEvents)),
                              ...
                              switch (
                                ...
                                case u:
                                  ...
                                  g.options.onCreateTextNode &&
                                    ...
                                    (A = g.options.onCreateTextNode(E, T)),
                                    A &&
                                      (O
                                        ? O.appendChild(A)
                ...
                2492: (e, t, r) => {
                  ...
                  e.exports = function (e, t, r, h, y, b) {
                    ...
                    if (E && !w)
                      return (
                        b || (b = new n()),
                        _ || p(e) ? o(e, t, r, h, y, b) : a(e, t, g, r, h, y, b)
                      );
                    if (!(1 & r)) {
                  ...
                  e.exports = function (e, t, r, i, s, u) {
                    ...
                    for (u.set(e, t), u.set(t, e); ++d < p; ) {
                      var b = e[d],
                        _ = t[d];
                      if (i)
                        var m = c ? i(_, b, d, t, e, u) : i(b, _, d, e, t, u);
                      if (void 0 !== m) {
                        if (m) continue;
                        h = !1;
                        break;
                  ...
                  e.exports = function (e, t, r, n, c, l, f) {
                    switch (r) {
                      ...
                      case "[object ArrayBuffer]":
                        return !(
                          e.byteLength != t.byteLength || !l(new o(e), new o(t))
                        );
                      case "[object Boolean]":
                      case "[object Date]":
                      case "[object Number]":
                      ...
                      case "[object Set]":
                        var d = 1 & n;
                        if ((v || (v = u), e.size != t.size && !d)) break;
                        var h = f.get(e);
                        if (h) return h == t;
                        (n |= 2), f.set(e, t);
                  ...
                  e.exports = function (e, t, r, a, i, s) {
                    ...
                    for (var y = u; ++l < p; ) {
                      var b = e[(f = c[l])],
                        _ = t[f];
                      if (a)
                        var m = u ? a(_, b, f, t, e, s) : a(b, _, f, e, t, s);
                ...
                4087: (e, t, r) => {
                  ...
                  if (!s || !u) {
                    ...
                    (s = function (e) {
                      ...
                      return (
                        f.push({ handle: ++l, callback: e, cancelled: !1 }), l
                      );
                    }),
                      (u = function (e) {
              ...
              (() => {
                ...
                var l = (function (e) {
                  ...
                  function l() {
                    ...
                    for (
                      var e, t, r, n, o = arguments.length, i = Array(o), s = 0;
                      s < o;
                      s++
                    )
                      i[s] = arguments[s];
