                    ...
                    <div className="mantine-Text-root mantine-1d564l0">
                      <div className="shadow-xl border p-4">
                        ...
                        <p className="text-center px-2 font-normal text-gray-500 text-base leading-loose">
                          Опираясь на наши обширные отраслевые знания и огромные
                          связи, наша команда консультантов готова предоставлять
                          высокопоставленным лицам краткосрочную поддержку во
                          время сезонных пиков или для удовлетворения уникальных
                          потребностей с вашим проектом.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="mantine-Text-root mantine-1d564l0">
                      <div className="shadow-xl border p-4">
                        ...
                        <p className="text-center px-2 font-normal text-gray-500 text-base leading-loose">
                          Наши опытные специалисты по подбору персонала
                          специализируются на поиске людей, которые усилят ваш
                          проект и поднимят его на новую высоту. Мы расставляем
                          приоритеты, вашу культуру и ценности, обеспечивая
                          профессиональную производительность, которая постоянно
                    ...
                    <div className="mantine-Text-root mantine-1d564l0">
                      <div className="shadow-xl border">
                        ...
                        <p className="text-center px-4 font-normal text-gray-500 text-base leading-loose">
                          Магнит предлагает эксклюзивные услуги по собственной
                          базе, выделение консультантов для определения
                          приоритетов вашего требования. Мы занимаемся целевым
                          хедхантингом, наймите профессионалов высочайшего
                          уровня для вашей организации, сдача в оговоренные
                          сроки без ущерба для качества обслуживания.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="mantine-Text-root mantine-1d564l0">
                      <div className="shadow-xl border">
                        ...
                        <p className="text-center px-4 font-normal text-gray-500 text-base leading-loose">
                          Признавая, что набор персонала выходит за рамки
                          заполнения вакансии, мы предлагаем индивидуальные
                          пакеты для удовлетворения ваших конкретные
                          потребности. Будь то создание рабочих мест
                          спецификации или создание профессиональных команд под
                          требования проекта, наши лучшие консультанты готовы
                          сотрудничать с вами и для вас.
                        </p>
                      </div>
                    </div>
                  </div>
